...
public class BinaryTree<Key extends Comparable<Key>> {
	...
	public int size(BTNode<Integer> n) {     // n를 루트로 하는 (서브)트리에 있는 노드 수
		if(n == null)
	...
	public void levelorder(BTNode<Integer> root) {   // 레벨순회
		Queue<BTNode<Integer> > q = new LinkedList<BTNode<Integer>>(); // 큐 자료 구조 이용
		BTNode<Integer> t;
